          ...
          >
            <div className={`grid grid-cols-2 p-4  whitespace-nowrap items-center`}>
              ...
              >
                ...
                <span>
                  <h1 className='text-sm uppercase text-maintext '>UFG by id</h1>
                </span>
              </div>
              {/* Menu Close/Open Controls and Search */}
              <div className='flex justify-end p-2'>
                <button onClick={()=>navigate(`/concessions`)} className={`${!UFASidePanelVisibility ? " px-1 py-2  rounded-md" : ""}`}>
                  <CgClose
